...
import static java.time.DayOfWeek.*;  //* is considered okay for static imports
...
//         testElectionDay();
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate bday2 = nyd.plusWeeks(38);
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1993, 03, 03);
    ...
    public static void testLaborDay() {
        LocalDate sep1 = LocalDate.of(1993, 9, 01);
    ...
    public static void testElectionDay() {
        LocalDate nov1 = LocalDate.of(2024, 11, 01);
    ...
    public static void testAnniversary() {
        ...
        LocalDate ann50 = wedding.plusYears(50);
        LocalDate party = ann50.with(nextOrSame(SATURDAY));
        System.out.println(ann50);
